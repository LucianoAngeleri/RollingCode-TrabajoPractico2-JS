...
switch (true) {
    case nota >= 0 && nota <= 2.5:
      document.write(`<p class="text-center text-danger fs-2">Su calificación es ${nota}, es MUY DEFICIENTE</p>"`);
      break;
    case nota > 2.5 && nota <= 4.5:
      document.write(`<p class="text-center text-warning fs-2">Su calificación es ${nota}, es INSUFICIENTE</p>"`);
      break;
    case nota > 4.5 && nota <= 6.5:
      document.write(`<p class="text-center text-success fs-2">Su calificación es ${nota}, es SUFICIENTE</p>"`);
      break;
    case nota > 6.5 && nota <= 8.5:
      document.write(`<p class="text-center text-success fs-2">Su calificación es ${nota}, es BUENO</p>"`);
      break;
    case nota > 8.5 && nota <= 9.5:
      document.write(`<p class="text-center text-success fs-2">Su calificación es ${nota}, es NOTABLE</p>"`);
      break;
    case nota > 9.5 && nota <= 10:
      document.write(`<p class="text-center text-success fs-2">Su calificación es ${nota}, es SOBRESALIENTE</p>"`);
      break;
  }